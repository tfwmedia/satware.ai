---
title: "satware® AI chat Webinar: KI als digitaler Kollege im Handwerk – Gunta Alesi live"
description: "Entdecken Sie am 13. Juni 2025 um 14:00 Uhr, wie KI Ihre Handwerksmitarbeiter bei Projektplanung, Materialmanagement und Arbeitsorganisation unterstützt. Live-Demo mit Gunta Alesi!"
date: 2025-06-09
authors:
  - jane-alesi
categories:
...
# satware® AI chat Webinar: KI als digitaler Kollege im Handwerk – Gunta Alesi live

**Entdecken Sie am 13. Juni 2025 um 14:00 Uhr, wie KI Ihre Handwerksmitarbeiter bei Projektplanung, Materialmanagement und Arbeitsorganisation unterstützt. Erleben Sie live, wie transparente KI Ihren Betrieb revolutioniert!**

## 🔨 Das deutsche Handwerk steht vor enormen Herausforderungen

Die Zahlen sprechen eine klare Sprache: **81% der Ausbaugewerbe-Betriebe** kämpfen mit Fachkräftemangel, **38% erwarten sinkende Umsätze** und **85% stehen unter massivem Kostendruck**. Gleichzeitig sinken die Auftragsreichweiten von 10,9 auf nur noch 9,5 Wochen.
...
### 🏗️ **Die Alesi KI-Agenten für Ihr Handwerk**

Entdecken Sie drei spezialisierte KI-Assistenten aus der Alesi-Familie, die in satware® AI chat auf Sie warten:

**Gunta Alesi - Ihre Handwerks-Expertin (HAUPTAGENT)**

- Spezialistin für alle Handwerksbereiche mit Fokus auf Prozessoptimierung
- Unterstützt bei komplexer Projektplanung und Materialbedarfsermittlung
- Optimiert Ressourcenmanagement und Qualitätssicherung
- Verbindet traditionelle Handwerkswerte mit moderner KI-Technologie

**Luna Alesi - Ihre Organisations-Expertin**

- Löst Kommunikationsprobleme zwischen Werkstatt und Montage
- Strukturiert Arbeitsabläufe und optimiert Teamorganisation
- Unterstützt bei Projektkoordination zwischen verschiedenen Gewerken
- Besonders wertvoll für mittlere bis größere Handwerksbetriebe

**Justus Alesi - Ihr Berater für rechtliche Orientierung**

- Gibt allgemeine rechtliche Empfehlungen (keine Rechtsberatung)
- Hilft bei der Orientierung in rechtlichen Fragen des Handwerks
- Erklärt wichtige Compliance-Grundlagen verständlich
- Unterstützt bei Gewährleistungsrecht und Vertragsfragen
...
- Strukturierte, hilfreiche Antworten für Ihre Handwerks-Herausforderungen erhalten
...
## Warum ist dieses Webinar perfekt für Handwerksbetriebe?

### ✅ **Konkrete Handwerks-Herausforderungen lösen**
Keine abstrakten Theorien – nur praktische Hilfe für echte Probleme Ihres Betriebs.

### ✅ **Sofort anwendbar**
Was Sie lernen, können Sie direkt nach dem Webinar selbst ausprobieren.

### ✅ **Messbare Erfolge**
Frühe KI-Adopter im Handwerk erzielen bereits:
- **30-50% Zeitersparnis** in Backoffice-Prozessen
- **18% weniger Materialverschnitt** durch bessere Planung
- **10-15% höhere Margen** durch optimierte Abläufe

### ✅ **AI Act-konform**
Seit August 2024 verpflichtet der AI Act zu Mitarbeiterschulungen – unser Webinar unterstützt Sie dabei.
...
### 🏭 **Für jeden Handwerksbereich**

- **Ausbaugewerbe**: Elektrik, Schreinerei, Malerei, Installation
- **Bauhauptgewerbe**: Maurerarbeiten, Betonbau, Straßenbau
- **Metallgewerbe**: Metallbau, Anlagenmechanik, Klempnerei
...
- Begrüßung durch Michael Wegener (Entwickler der Alesi-Familie)
- Was Sie heute erwartet
- Wichtige Hinweise für Handwerksbetriebe

**14:05 - 14:15 Uhr: "satware® AI chat für das Handwerk"**

- Die Alesi KI-Agenten Familie im Überblick
- Erste Schritte in satware® AI chat
- Transparentes Reasoning live erleben

**14:15 - 14:45 Uhr: Live-Demonstrationen**

- **Gunta in Aktion**: "Projektplanung Elektrikerbetrieb" – Verkabelung eines 4-stöckigen Bürogebäudes mit 8 Mitarbeitern in 6 Wochen
- **Luna optimiert**: "Teamorganisation Schreinerei" – Lösung von Koordinationsproblemen zwischen Werkstatt und Montage
- **Justus berät**: "Gewährleistungsrecht im Handwerk" – Allgemeine rechtliche Orientierung für Mitarbeiter

**14:45 - 14:50 Uhr: Vertrauen & Transparenz**

- Häufige Bedenken adressieren
- Praxisbeispiel: ROI-Berechnung für einen 8-Mann-Betrieb
- Datenschutz und Compliance

**14:50 - 15:00 Uhr: Ihre Fragen**

- Live-Antworten durch die drei Agenten
- Praktische Tipps für den Einstieg
- Kostenloser 14-Tage-Test für Handwerksbetriebe
...
??? question "Brauche ich technische Vorkenntnisse?"
    Nein! Das Webinar ist speziell für Handwerksbetriebe konzipiert, die noch keine KI-Erfahrung haben.

??? question "Ist das Webinar wirklich kostenlos?"
    Ja, komplett kostenlos und unverbindlich.

??? question "Was passiert nach dem Webinar?"
    Sie erhalten wertvolle Handwerks-Materialien und können alle Ihre KI-Fragen direkt an unsere Experten stellen – ohne jede Verpflichtung.

??? question "Kann ich Fragen stellen?"
    Ja! Die letzten 10 Minuten sind für Ihre Fragen reserviert. Stellen Sie alle Fragen, die Sie schon immer zur KI im Handwerk interessiert haben!
...
!!! note "Rechtliche Empfehlungen, keine Beratung"
    Justus Alesi gibt allgemeine rechtliche Empfehlungen und Orientierungshilfen. Das ist KEINE individuelle Rechtsberatung im Sinne des Rechtsdienstleistungsgesetzes (RDG). Für wichtige rechtliche Entscheidungen in Ihrem Betrieb konsultieren Sie bitte einen qualifizierten Rechtsanwalt.
